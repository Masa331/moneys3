...
module MoneyS3
  module Builders
    class DokladFirmaType
      ...
      attr_accessor :obch_nazev, :fakt_nazev, :ico, :dic, :dicsk, :guid, :nazev, :e_mail, :www, :platce_dph, :fyz_osoba, :banka, :ucet, :kod_banky, :v_symb, :spec_sym, :kod_partn, :obch_adresa, :fakt_adresa, :adresa, :tel, :fax, :mobil, :isdoc, :eshop
